...
// CreateWorkOrderRequest defines the structure for a request to create a new work order.
...
// WorkOrderResponse defines the structure for a response containing work order details.
