...
func (s *serviceImpl) GetProductionPlanByID(ctx context.Context, id uuid.UUID) (*ProductionPlanResponse, error) {
	tenantID := tenantIDFromContext(ctx)
...
func (s *serviceImpl) UpdateProductionPlan(ctx context.Context, id uuid.UUID, req *UpdateProductionPlanRequest) (*ProductionPlanResponse, error) {
	tenantID := tenantIDFromContext(ctx)
	entity, err := s.repository.GetByID(ctx, tenantID, id)
	if err != nil {
		return nil, err
...
func (s *serviceImpl) ReleaseProductionPlan(ctx context.Context, id uuid.UUID) error {
	tenantID := tenantIDFromContext(ctx)
	entity, err := s.repository.GetByID(ctx, tenantID, id)
	if err != nil {
		return err
...
func (s *serviceImpl) CancelProductionPlan(ctx context.Context, id uuid.UUID) error {
	tenantID := tenantIDFromContext(ctx)
	entity, err := s.repository.GetByID(ctx, tenantID, id)
	if err != nil {
		return err
