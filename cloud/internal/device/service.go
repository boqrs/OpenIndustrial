...
type Service interface {
	CreateDevice(ctx context.Context, req *param.CreateDeviceRequest) (*param.BootstrapCredentialResponse, error)
	GetDevice(ctx context.Context, deviceID uuid.UUID) (*param.DeviceResponse, error)
	ListDevices(ctx context.Context, req *param.ListDevicesRequest) (*param.ListDevicesResponse, error)
...
func (s *serviceImpl) CreateDevice(ctx context.Context, req *param.CreateDeviceRequest) (*param.BootstrapCredentialResponse, error) {
	...
	resourceReq := &param.CreateResource{
	...
	var bootstrapCred *param.BootstrapCredentialResponse
	cbReq := param.CreateBootstrapCredentialRequest{
		ResourceID: createdResource.UUID,
	}
...
func (s *serviceImpl) ListDevices(ctx context.Context, req *param.ListDevicesRequest) (*param.ListDevicesResponse, error) {
	// Default pagination
	if req.Page <= 0 {
		req.Page = 1
	}
	...
	responses := make([]*param.DeviceResponse, 0, len(items))
	...
	return &param.ListDevicesResponse{
		Items:      responses,
		Total:      total,
		Page:       req.Page,
...
func (s *serviceImpl) toDeviceResponse(d *model.Device, r *model.Resource) *param.DeviceResponse {
	resp := &param.DeviceResponse{
		ID:               d.ID,
