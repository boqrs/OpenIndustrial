...
type Service interface {
	...
	CreateProductModel(ctx context.Context,req *param.CreateProductModelRequest,) (*param.ProductModelResponse, error)
	GetProductModel(ctx context.Context,id uuid.UUID) (*param.ProductModelResponse, error)
	ListProductModels(ctx context.Context,req *param.ListProductModelsRequest) (*param.ProductModelListResponse, error)
	UpdateProductModel(ctx context.Context,id uuid.UUID,req *param.UpdateProductModelRequest) (*param.ProductModelResponse, error)
	//TODO： 改为resource定义的状态类型
	UpdateProductModelStatus(ctx context.Context,id uuid.UUID,status string) error

	// =========================================================
	// Product Model Attribute Definition
	// =========================================================

	GetAttributeDefinitions(ctx context.Context,productModelID uuid.UUID) ([]param.AttributeDefinitionResponse, error)

	UpdateAttributeDefinitions(ctx context.Context,productModelID uuid.UUID,req *param.UpdateAttributeDefinitionsRequest) error
}
...
func (s *serviceImpl) CreateProductModel(ctx context.Context, req *param.CreateProductModelRequest) (*param.ProductModelResponse, error) {
	// 1. Validate request
	if req == nil {
	...
	resourceEntity, err := s.resourceSvc.CreateResource(ctx, &param.CreateResource{
		TenantID: tenantID,
...
func (s *serviceImpl) GetProductModel(ctx context.Context, id uuid.UUID) (*param.ProductModelResponse, error) {
...
func (s *serviceImpl) ListProductModels(ctx context.Context, req *param.ListProductModelsRequest) (*param.ProductModelListResponse, error) {
	if req == nil {
	...
	result := &param.ProductModelListResponse{
		Items:    make([]*param.ProductModelResponse, 0, len(items)),
		Page:     req.Page,
...
func (s *serviceImpl) UpdateProductModel(ctx context.Context, id uuid.UUID, req *param.UpdateProductModelRequest) (*param.ProductModelResponse, error) {
	if req == nil {
		return nil, errors.New("request is nil")
	}
...
func (s *serviceImpl) GetAttributeDefinitions(ctx context.Context, productModelID uuid.UUID) ([]param.AttributeDefinitionResponse, error) {
	...
	result := make([]param.AttributeDefinitionResponse, 0, len(definitions))
	for _, definition := range definitions {
		result = append(result, param.AttributeDefinitionResponse{
			ID:          definition.UUID,
...
func (s *serviceImpl) UpdateAttributeDefinitions(ctx context.Context, productModelID uuid.UUID, req *param.UpdateAttributeDefinitionsRequest) error {
	if req == nil {
...
func (s *serviceImpl) buildProductModelResponse(ctx context.Context, resourceEntity *model.Resource, entity *model.ProductModel) (*param.ProductModelResponse, error) {
	definitions, err := s.resourceSvc.FindAttributeDefinitionByResourceID(ctx, entity.ResourceID)
	if err != nil {
		return nil, fmt.Errorf("failed to find attribute definitions: %w", err)
	}

	attributes := make([]param.AttributeDefinitionResponse, 0, len(definitions))
	for _, definition := range definitions {
		attributes = append(attributes, param.AttributeDefinitionResponse{
			ID:          definition.UUID,
			Name:        definition.Name,
			Label:       definition.Label,
			Description: definition.Description,
	...
	return &param.ProductModelResponse{
		ID:          entity.ID,
		ResourceID:  entity.ResourceID,
		Name:        resourceEntity.ResourceName,
		Code:        entity.Code,
...
func validateAttributeDefinitions(attributes map[string]param.AttributeDefinitionRequest) error {
